...
class LocaleGenSbWriter {
  ...
  static String createLocalizationFile(LocaleGenParams params, Map<String, dynamic> defaultTranslations, Map<String, Map<String, dynamic>> allTranslations) {
    ...
    sb
      ...
      ..writeln('    }')
      ..writeln("    final jsonContent = await rootBundle.loadString('${params.assetsDir}\${locale.toLanguageTag()}.json', cache: useCaching);")
  ...
  static String createLocalizationDelegateFile(LocaleGenParams params) {
    ...
    params.languages
      ..sort((a1, a2) => a1 == params.defaultLanguage || a2 != params.defaultLanguage ? 0 : 1)
      ..forEach((language) => sb.writeln(LocaleGenParser.parseSupportedLocale(language)));
    sb
      ..writeln('  ];')
      ..writeln()
